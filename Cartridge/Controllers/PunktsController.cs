...
namespace Cartridge.Controllers
{
    public class PunktsController : Controller
    {
        ...
        {
            return View(_context.PrintersModel.ToList());
        }
        ...
        public async Task<IActionResult> Create([Bind("Name")] Punkt punkt, int[] selectedPrint)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    foreach (var c in _context.PrintersModel.Where(pr => selectedPrint.Contains(pr.Id)))
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewBag.ModelPrinter = _context.PrintersModel.ToList();
            return View(punkt);
        }
